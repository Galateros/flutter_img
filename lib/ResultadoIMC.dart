...
class ResultadoIMC extends StatelessWidget {
    ...
    Widget build(BuildContext context) {
        ...
        imcModelo.esNormal ? Text("IMC Normal", style: TextStyle(color: Colors.red[700], fontSize: 34, fontWeight: FontWeight.w700),)
        :Text("IMC Anormal", style: TextStyle(color: Colors.red[700], fontSize: 34, fontWeight: FontWeight.w700),)
        ,
        SizedBox(height: 16,),
